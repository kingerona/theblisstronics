        ...
        <div className="container">
            <div className="row">
                <div className="col-lg-12">
                    <h6><span className="icon_tag_alt"></span> Have a coupon? <a href="example.com">Click here</a> to enter your code
                    </h6>
                </div>
            </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="checkout__order">
                                ...
                                <ul>
                                    <li>Gigabyte Package <span>$75.99</span></li>
                                    <li>Asus Rogue Package <span>$151.99</span></li>
                                    <li>Ventus Package <span>$53.99</span></li>
                                </ul>
