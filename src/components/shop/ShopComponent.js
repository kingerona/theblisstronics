                                ...
                                <div className="latest-product__text">
                                    ...
                                    <div className="latest-product__slider owl-carousel">
                                        <div className="latest-prdouct__slider__item">
                                            <a href="example.com" className="latest-product__item">
                                ...
                                <div className="product__discount__slider owl-carousel">
                                    <div className="col-lg-4">
                                        <div className="product__discount__item">
                                            ...
                                            <div className="product__discount__item__text">
                                                <span>Laptops</span>
                                                <h5><a href="example.com">DEL Laptop</a></h5>
                                    ...
                                    <div className="col-lg-4">
                                        <div className="product__discount__item">
                                            ...
                                            <div className="product__discount__item__text">
                                                <span>Mouses</span>
                                                <h5><a href="example.com">Ventus X Mouse</a></h5>
                                                <div className="product__item__price">$30.00 <span>$36.00</span></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-lg-4">
                                        <div className="product__discount__item">
                                            ...
                                            <div className="product__discount__item__text">
                                                <span>Laptops</span>
                                                <h5><a href="example.com">Asus Laptop</a></h5>
                                                <div className="product__item__price">$30.00 <span>$36.00</span></div>
                                            </div>
                                        </div>
                                    </div>
